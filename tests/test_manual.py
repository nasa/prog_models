...
class TestManual(unittest.TestCase):
    ...
    def test_nasa_battery_download(self):
        ...
        assert_array_equal(data[0][0], array([1.500000e-01, 1.800000e-02, 4.196000e+00, 1.837451e+01]))
        assert_array_equal(data[0][-1], array([1.8897668e+05, 4.0000000e-02, 3.2000000e+00, 1.7886300e+01]))
        assert_array_equal(data[8532][0], array([1.000000e-02, 0.000000e+00, 3.645000e+00, 3.124247e+01]))
        assert_array_equal(data[8532][-1], array([0.54, 0, 3.716, 31.24247]))
        assert_array_equal(data[-1][0], array([0.04, 3.004, 3.647, 28.08937]))
        assert_array_equal(data[-1][-1], array([178.38, 3, 3.2, 32.53947]))
