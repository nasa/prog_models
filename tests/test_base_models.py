...
class TestModels(unittest.TestCase):
    ...
    def test_next_time_fcn(self):
        ...
        # Should override dt of 1 with next_time function (which sets dt to 0.5)
        (times, inputs, states, outputs, event_states) = m.simulate_to_threshold(load, {'o1': 0.8}, **{'dt': 1, 'save_freq': 1e-99, 'next_time_fcn': next_time})
