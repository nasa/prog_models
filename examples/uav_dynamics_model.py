...
from prog_models.loading.controller_test import ExampleController
...
def run_example(): 
    ...
    ref_traj = traj_gen(waypoints, **vehicle_params)

    # Define controller
    ctrl = ExampleController(ref_traj,**vehicle_params)

    # Set simulation options 
    options = {
        'dt': 0.2, ### THIS IS CURRENTLY REQUIRED - this needs help, issue with consistency in dt 
