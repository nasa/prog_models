...
def run_example(): 
    ...
    options_surrogate = {
        ...
        'trim_data_to': 0.9, # Value between 0 and 1 that determines the fraction of data resulting from simulate_to_threshold that is used to train DMD surrogate model
        'training_noise': 0.01,
        'outputs': ['v']
    }
